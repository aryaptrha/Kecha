            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {viralSongs.map((song, i) => (
                <motion.div
                  ...
                  className="bg-primary text-background border-4 border-secondary p-5 flex flex-col justify-between h-48 relative shadow-[4px_4px_0px_0px_var(--color-secondary)] hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_var(--color-secondary)] transition-all duration-200"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredSongs.map((song, i) => (
                <motion.div
                  ...
                  className="bg-surface border-2 border-secondary p-5 flex flex-col justify-between hover:shadow-[4px_4px_0px_0px_var(--color-secondary)] hover:-translate-y-1 active:translate-x-0 active:translate-y-0 active:shadow-none transition-all duration-200 group"
                >
                  <div>
